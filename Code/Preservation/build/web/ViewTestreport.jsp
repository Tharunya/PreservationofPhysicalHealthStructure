...
{
if(document.PatientDetailsForm.regno.value=="")
{
alert("Enter registration number");
document.PatientDetailsForm.regno.focus();
return false;
}
return true;
}
...
<FORM  name="form" onSubmit="return RegistrationNo()"
action="./ViewTestReport1.jsp"
method=get encType=multipart/form-data>
                  <TABLE cellSpacing=0 cellPadding=0 width=530 align=center 
                  border=0>
                    <TBODY>
                    <TR>
                      <TD class=boldbigblue vAlign=top align=left>Patient TestReport </TD>
                    </TR>
                    <TR>
                      ...
                      <TD vAlign=top align=left>
                        ...
                        width=530 align=center border=0>
                          ...
                          <TR>
                            ...
                            <TD vAlign=top align=left height=22>Enter the patients Registration No </TD>
                          ...
                          <TR>
                            ...
                            <TD vAlign=top align=middle>
                              ...
                              align=center cellPadding=0 cellSpacing=0>
                                ...
                                bgColor=#eee9f8 colSpan=3 height=29><input name="regno" type="text" id="regno" onKeyPress="return number(event)">
                                  <SPAN 
