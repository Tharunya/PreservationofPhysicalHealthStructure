...
function callMe()
{
return (CPassword() && newpassword() && conpassword())
}
...
%>
<form id="form" name="Form" action="./ChangeAdminPassword.jsp" onSubmit="return callMe()" method="post">

                  <TABLE cellSpacing=0 cellPadding=0 width=530 align=center 
                  border=0>
                    <TBODY>
                    <TR>
                      <TD class=boldbigblue vAlign=top align=left>Change Administrator Password</TD>
                    </TR>
                    <TR>
                          ...
                          <TR>
                            ...
                            <TD vAlign=top align=middle>
                              ...
                              align=center cellPadding=0 cellSpacing=0>
                                ...
                                name="uname" 
                                class=bodytext id="uname" readonly="" value="<%out.println(uname);%>">
                                <SPAN 
                                ...
                                class="bodytext" onFocus="return CPassword()"><SPAN 
                                id=ctl00_ContentPlaceHolder_RFVName 
                                style="DISPLAY: none; COLOR: red"></SPAN><SPAN 
                                id=ctl00_ContentPlaceHolder_REVName 
                                ...
                                class="bodytext" onFocus="return newpassword()">
                                  <SPAN 
