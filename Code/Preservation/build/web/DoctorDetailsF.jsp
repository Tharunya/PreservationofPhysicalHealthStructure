...
function Docid()
{
if(document.PatientDetailsForm.docid.value=="")
{
alert("Enter Doctor Id");
document.PatientDetailsForm.docid.focus();
return false;
}
return true;
}
...
function number(e)
{
var a=document.PatientDetailsForm.id.value;
...
<FORM  name="PatientDetailsForm" onSubmit="return Docid()" action="./ViewDoctorDetails.jsp"
                      ...
                      <TD vAlign=top align=left>
                        ...
                        width=530 align=center border=0>
                          ...
                          <TR>
                            ...
                            <TD vAlign=top align=left height=22>Enter the Doctor Registration No </TD>
                          ...
                          <TR>
                            ...
                            <TD vAlign=top align=middle>
                              ...
                              align=center cellPadding=0 cellSpacing=0>
                                ...
                                bgColor=#eee9f8 colSpan=3 height=29><input name="docid" type="text" id="docid" onKeyPress="return number(event)">
                                  <SPAN 
							  ...
							  <div align="center">
                                <INPUT class=bodytext id=ctl00_ContentPlaceHolder_BtnSignUP onclick='javascript:WebForm_DoPostBackWithOptions(new WebForm_PostBackOptions("ctl00$ContentPlaceHolder$BtnSignUP", "", true, "", "", false, false))' type=submit value="Submit" name=SignUP>
