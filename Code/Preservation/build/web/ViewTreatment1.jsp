...
int Pid=Integer.parseInt(request.getParameter("regno"));
	...
	Connection con=DriverManager.getConnection("jdbc:odbc:HCS");
		PreparedStatement ps=con.prepareStatement("select * from Treatment Where Pid=?");
		ps.setInt(1,Pid);
          ...
          <TD align=left><IMG 
            ...
            type="button"></TD>
                  ...
                  border=0>
                    <TBODY>
                    <TR>
                      <TD class=boldbigblue vAlign=top align=left>Patient Treatment Details</TD>
                      ...
                      <TD vAlign=top align=left>
                        ...
                        width=900 align=center border=0>
                          ...
                          <TR bgcolor="#eee9f8">
							...
							<TD width=101 height=22 align=left vAlign=top class="style3"><div align="center">Diesease</div></TD>
							<TD width=101 height=22 align=left vAlign=top class="style3"><div align="right">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Medicine</div></TD>
							<TD width=101 height=22 align=left vAlign=top class="style3"><div align="center">FeedBack</div></TD>
				...
				%>
                          ...
                          <TR bgcolor="#F0F0F0">
                            <TD width=101 align=left vAlign=top>
									...
									<TD align=middle vAlign=top> <div align="center" class="style6"><%out.println(Diesease);%> </div></TD>
									<TD align=middle vAlign=top> <div align="center" class="style6"><%out.println(Medcine+"<br>");%> </div></TD>
                            	   <TD width=101 align=left vAlign=top><div align="center" class="style6"><%out.println(FeedBack+"<br>");%></div></TD>
