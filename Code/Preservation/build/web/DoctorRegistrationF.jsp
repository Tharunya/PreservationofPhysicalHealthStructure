...
function callMe()
{
return (docid() && Fname() && Lname() && jdate() && mail() && phno() && qualification() && desgntn() && spcl() && whrs() && Ds() && uname() && pword())
}

function docid()
{
if(document.Form.DocId.value=="")
{
alert("Enter doctorId");
...
function spcl()
{
if(document.Form.Specialisation.value=="0")
{
...
function whrs()
{
if(document.Form.WorkingHours.value=="")
{
alert("Enter WorkingHours");
document.Form.WorkingHours.focus();
return false;
}
return true;
}
...
function Ds()
{
if(document.Form.DStatus.value=="")
{
alert("Enter DStatus");
document.Form.DStatus.focus();
return false;
}
return true;
}
...
method=post>
                  ...
                  border=0>
                    <TBODY>
                    <TR>
                      <TD class=boldbigblue vAlign=top align=left>Doctor Registration</TD>
                    </TR>
                    <TR>
...
<a href="javascript:NewCal('JoinDate','yyyymmdd')"><img src="images/cal.gif" width="16" height="16" border="0" alt="Pick a date" ></a>                                  <SPAN 
                                ...
                                style="COLOR: red">
                                  <INPUT 
                                name="UserName" 
                                class=bodytext id="UserName" onFocus="return Ds()">
                                </SPAN><SPAN 
                                id=ctl00_ContentPlaceHolder_RFVPassword 
                                style="DISPLAY: none; COLOR: red"></SPAN></TD>
                                </TR><TR bgcolor="#F0F0F0">
                                <TD class=border_bottom align=left height=29><SPAN 
                                class=forms_text>Passsword</SPAN></TD>
                                <TD class=border_left_bottom vAlign=top 
                                align=left height=29></TD>
                                <TD class=border_bottom vAlign=center align=left colSpan=3 height=29><SPAN 
                                id=ctl00_ContentPlaceHolder_LblPwdErr 
