...
function callMe()
{
return (empnum() && uname() &&  pword() &&  confirmpass())
}
...
<FORM id="Form" name="Form" onSubmit="return callMe()" 
 action="./DeleteEmplyee.jsp"
method=get encType=multipart/form-data>
                  <TABLE cellSpacing=0 cellPadding=0 width=530 align=center 
                  border=0>
                    <TBODY>
                    <TR>
                      <TD class=boldbigblue vAlign=top align=left>Delete Employee</TD>
                    </TR>
                    <TR>
                          ...
                          <TR>
                            ...
                            <TD vAlign=top align=middle>
                              ...
                              align=center cellPadding=0 cellSpacing=0>
                                ...
                                name="EmpNo" 
                                class=bodytext id="EmpNo" onKeyPress="return nember(event)">
                                <SPAN 
                                ...
                                name="UserName" 
                                class=bodytext id="UserName" onFocus="return empnum()">
                                <SPAN 
                                id=ctl00_ContentPlaceHolder_RFVName 
                                style="DISPLAY: none; COLOR: red"></SPAN><SPAN 
                                id=ctl00_ContentPlaceHolder_REVName 
                                ...
                                class=bodytext id="conpass" onFocus="return  pword()">
                                  <SPAN 
