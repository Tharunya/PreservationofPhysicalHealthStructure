...
<ul id="aside">
<li><a href="DoctorRegistrationF.jsp" target="body" style="font-style:normal;">Doctor registration</a></li>
<li><a href="EmployeeRegistrationF.jsp" target="body" style="font-style:normal;">Employee registration</a></li>
<li><a href="ChangeAdminPasswordF.jsp" target="body" style="font-style:normal;">Change password</a></li>
<li><a href="DeleteEmplyeeF.jsp" target="body" style="font-style:normal;">Delete employee</a></li>
<li><a href="DeleteDoctorF.jsp" target="body" style="font-style:normal;">Delete doctor</a></li>
<li><a href="AdminEditProfileF.jsp" target="body" style="font-style:normal;">Edit profile</a></li>
<li><a href="EditOrgAddrsF.jsp" target="body" style="font-style:normal;">Edit organaization profile</a></li>
<li><a href="DoctorDetailsF.jsp" target="body" style="font-style:normal;">View Doctor details</a></li>
<li><a href="EmployeeDetailsF.jsp" target="body" style="font-style:normal;">View employee details</a></li>

</ul>

</div>
<div id="right1">
<iframe src="adminhome.html"  frameborder="2" name="body" style="overflow:scroll;height:680px; width:703px;border:2px solid lightblue;">hji</iframe>
