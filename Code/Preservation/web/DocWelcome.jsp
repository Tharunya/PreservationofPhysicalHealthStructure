...
<div style="clear:both;"></div>
<div id="nav" style="width:100%;height:40px;background-color:#f9f9f9;font-family:Arial, Helvetica, sans-serif;">
<ul id="menu2">
...
<ul id="aside">
<li><a href="ChangeDoctorPasswordF.jsp" target="body" style="font-style:normal;">Change password</a></li>
<li><a href="EditDoctorProfileF.jsp" target="body" style="font-style:normal;">Edit profile</a></li>
<li><a href="PatientTreatmentF.jsp" target="body" style="font-style:normal;">Patient treatment</a></li>
<li><a href="ViewTreatment.jsp" target="body" style="font-style:normal;">View treatment</a></li>
<li><a href="DocScheduleF.jsp" target="body" style="font-style:normal;">Update treatment</a></li>
...
<div id="right1">
<iframe src="doctorhome.html"  frameborder="2" name="body" style="overflow:scroll;height:680px; width:703px;border:2px solid lightblue;">hji</iframe>

</div>

</div><!--content-->
<div style="clear:both;"></div>
<div id="footer" style="width:100%;height:20px;background-color:#7a98fa;margin-top:183px;">
