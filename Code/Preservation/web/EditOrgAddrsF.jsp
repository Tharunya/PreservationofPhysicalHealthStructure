...
onsubmit="javascript:return WebForm_OnSubmit();" action="./EditOrgAddrs.jsp" 
method=get >
                  <TABLE cellSpacing=0 cellPadding=0 width=530 align=center 
                  border=0>
                    <TBODY>
                    <TR>
                      <TD class=boldbigblue vAlign=top align=left>Edit Organisation Profile </TD>
                    </TR>
                    <TR>
                          ...
                          <TR>
                            ...
                            <TD vAlign=top align=middle>
                              ...
                              align=center cellPadding=0 cellSpacing=0>
                                ...
                                class=forms_text>Organisation Code </SPAN></TD>
                                ...
                                class=forms_text>Organisation Name</SPAN></TD>
                                <TD class=border_left_bottom vAlign=top 
                                align=left width=20 
                                height=26></TD>
                                <TD class=border_bottom vAlign=center align=left colSpan=3 height=26><INPUT class=bodytext
                                ...
                                class=forms_text>Address Line1</SPAN></TD>
                                <TD class=border_left_bottom vAlign=top 
                                ...
                                class=forms_text>Address Line2</SPAN></TD>
                                <TD class=border_left_bottom vAlign=top 
                                align=left width=20 bgColor=#eee9f8 
                                height=29></TD>
                                <TD class=border_bottom vAlign=center align=left 
                                bgColor=#eee9f8 colSpan=3 height=29><INPUT name="AddressLine2" type="text" 
                                class=bodytext>
                                  <SPAN 
